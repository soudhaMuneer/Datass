...
namespace HireMeNow_BlazorApp.Repositories
{
    ...
    {
        private List<Job> jobs = new List<Job> { new Job("Dotnet Developer","Senior dotnet developer .","Thrissur","Fulltime","100000-300000",new Guid("2c8303fb-c1e1-4fa6-a2e1-272472b4beb5"),"Aitrich",new Guid("62ec44fb-9f30-4f45-8e3d-f3751998af89")),
		...
		new Job("Angular Developer","Senior dotnet developer .","Banglure","Fulltime","100000-300000",new Guid("2c8303fb-c1e1-4fa6-a2e1-272472b4beb5"),"Aitrich"),
		new Job("Dotnet Developer","Senior dotnet developer .","Chennai","Fulltime","100000-300000",new Guid("2c8303fb-c1e1-4fa6-a2e1-272472b4beb5"),"Aitrich"),
		new Job("Dotnet Developer","Senior dotnet developer .","USA","Fulltime","100000-300000",new Guid("2c8303fb-c1e1-4fa6-a2e1-272472b4beb5"),"Aitrich")};
