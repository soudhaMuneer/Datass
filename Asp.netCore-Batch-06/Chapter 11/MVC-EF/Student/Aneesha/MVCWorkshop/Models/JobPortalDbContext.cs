...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-A4LFVAT;Initial Catalog=JobPortal_DB;Integrated Security=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Application>(entity =>
        {
            ...
            entity.HasIndex(e => e.CompanyId, "IX_Applications_CompanyId");
        ...
        modelBuilder.Entity<Experience>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "IX_Experiences_UserId");
        ...
        modelBuilder.Entity<Interview>(entity =>
        {
            ...
            entity.HasIndex(e => e.CreatedBy, "IX_Interviews_CreatedBy");

            entity.HasIndex(e => e.JobId, "IX_Interviews_JobId");

            entity.HasIndex(e => e.JobseekerId, "IX_Interviews_JobseekerId");
        ...
        modelBuilder.Entity<Job>(entity =>
        {
            ...
            entity.HasIndex(e => e.CreatedBy, "IX_Jobs_CreatedBy");
        ...
        modelBuilder.Entity<Qualification>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "IX_Qualifications_UserId");
