...
namespace Mvc_HireMeNow.Migrations
{
    ...
    [Migration("20230805092642_initial2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mvc_HireMeNow.Models.Application", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Mvc_HireMeNow.Models.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Mvc_HireMeNow.Models.Experience", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Mvc_HireMeNow.Models.Interview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Mvc_HireMeNow.Models.Job", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Mvc_HireMeNow.Models.Qualification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Mvc_HireMeNow.Models.Skill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Mvc_HireMeNow.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Mvc_HireMeNow.Models.Application", b =>
                {
                    b.HasOne("Mvc_HireMeNow.Models.Company", "Company")
                        .WithMany()
                        .HasForeignKey("CompanyId");

                    b.HasOne("Mvc_HireMeNow.Models.Job", "Job")
                        .WithMany("Applications")
                        .HasForeignKey("JobId")
                        .HasConstraintName("FK__Applicati__JobId__33D4B598");

                    b.HasOne("Mvc_HireMeNow.Models.User", "User")
                        .WithMany("Applications")
            ...
            modelBuilder.Entity("Mvc_HireMeNow.Models.Interview", b =>
                {
                    ...
                    b.HasOne("Mvc_HireMeNow.Models.User", "CreatedUser")
                    ...
                    b.HasOne("Mvc_HireMeNow.Models.User", "Jobseeker")
