...
namespace HireMeNowWebApi.Repositories
{
    ...
    {
        private List<User> users = new List<User> { new User( "jobprovider", "", "jobprovider@gmail.com", 123, "123", Roles.JobProvider,new Guid("3fa85f64-5717-4562-b3fc-2c963f66afa6")),
         new User( "Yadhu", "", "yadhu.aitrich@gmail.com", 123, "123", Roles.JobSeeker,new Guid("1d8303fb-c1e1-4fa6-a2e1-272472b2beb4")),
