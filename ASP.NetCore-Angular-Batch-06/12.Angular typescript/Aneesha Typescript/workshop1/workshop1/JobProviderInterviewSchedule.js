...
var JobProvider = /** @class */ (function () {
    ...
    JobProvider.prototype.scheduleInterviewlist = function () {
        var int = interviewList;
        console.log("\n--------------------------------------------------iNTERVIEW sCHEDULE lIST-----------------------------------------------\n");
        int.forEach(function (li) {
            console.log("JobTitle:" + li.jobTitle + " Date " + li.dateOfInterview + " Time: " + li.time + " Location: " + li.modeOfInterview + "\n");
        });
        console.log("\n------------------------------------------------------------------------------------------------------------\n");
    };
    return JobProvider;
