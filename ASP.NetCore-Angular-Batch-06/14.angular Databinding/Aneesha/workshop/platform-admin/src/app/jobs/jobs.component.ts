...
export class JobsComponent {
  ...
  over(resetNumber: any) {

    switch (resetNumber) {
      case 1: this.divBackgroundColor1 = this.status;
        break;
      case 2: this.divBackgroundColor2 = this.status;
        break;
      case 3: this.divBackgroundColor3 = this.status;
        break;
      case 4: this.divBackgroundColor4 = this.status;
        break;
      case 5: this.divBackgroundColor5 = this.status;
        break;
    }
