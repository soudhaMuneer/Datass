...
export class JobsComponent {
  ...
  hoverbg(resetNumber: any) {
    ...
    switch (resetNumber) {
      case 1: this.divBackgroundColor1 = this.topurple;
        break;
      case 2: this.divBackgroundColor2 = this.topurple;
        break;
      case 3: this.divBackgroundColor3 = this.topurple;
        break;
      case 4: this.divBackgroundColor4 = this.topurple;
        break;
      case 5: this.divBackgroundColor5 = this.topurple;
        break;
    }
